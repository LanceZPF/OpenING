...
TOTAL_DIR = "E:\\Users\Lance\\BaiduNetdiskDownload\\OpenING"
OUTPUT_DIR = 'E:\\Users\Lance\\BaiduNetdiskDownload\\GPT-4o+DALL-E3_output'
# OUTPUT_DIR = 'E:\\Users\Lance\\BaiduNetdiskDownload\\GPT-4o+DALL-E3_dumb-dev'  # Define your output directory
...
def generate_image(a_real_data, input_text, output_text, i_step):
    ...
    url = "https://api.claudeshop.top/v1/images/generations"
    headers = {
        "Content-Type": "application/json",
        "Authorization": f"Bearer {api_key}"
    }
...
def generate_image_with_input(a_real_data, input_text, output_text, i_step, input_image_path_list=None):
    # Define the API request URL and headers
    url = "https://api.claudeshop.top/v1/images/edits"
    # 设置 API 请求的URL
...
if __name__ == '__main__':
    ...
    with open(os.path.join(args.meta_path, 'zero-shot_generation_system.txt'), 'r') as f:
    ...
    for a_index, a_data in tqdm(enumerate(io_dir_list)):
        ...
        # if real_data_list[a_index]['subtask_name'] in edit_subtask_names:
        #     print(real_data_list[a_index])
        # else:
        #     continue

        # if input_image_path[0] == None:
        #     if real_data_list[a_index]['meta_task_name'] in runned_noinputtask_list:
        #         continue
        #     else:
        #         runned_noinputtask_list.append(real_data_list[a_index]['meta_task_name'])
        # else:
        #     if real_data_list[a_index]['meta_task_name'] in runned_inputtask_list:
        #         continue
        #     else:
        #         runned_inputtask_list.append(real_data_list[a_index]['meta_task_name'])
